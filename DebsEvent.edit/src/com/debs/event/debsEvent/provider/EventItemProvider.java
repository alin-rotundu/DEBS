...
/**
 * This is the item provider adapter for a {@link com.debs.event.debsEvent.Event} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DebsEventPackage.Literals.EVENT__TIMESTAMP,
				 true,
				 false,
				 false,
	...
	protected void addUserIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_userId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_userId_feature", "_UI_Event_type"),
				 DebsEventPackage.Literals.EVENT__USER_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	protected void addUserNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Event_userName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Event_userName_feature", "_UI_Event_type"),
				 DebsEventPackage.Literals.EVENT__USER_NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Event)object).getUserName();
	...
	public ResourceLocator getResourceLocator() {
		return DebsEventEditPlugin.INSTANCE;
	}
