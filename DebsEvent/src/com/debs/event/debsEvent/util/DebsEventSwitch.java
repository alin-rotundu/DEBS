...
public class DebsEventSwitch {
	...
	protected Object doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DebsEventPackage.EVENT: {
				Event event = (Event)theEObject;
				Object result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DebsEventPackage.POST: {
				Post post = (Post)theEObject;
				Object result = casePost(post);
				if (result == null) result = caseEvent(post);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DebsEventPackage.COMMENT: {
				Comment comment = (Comment)theEObject;
				Object result = caseComment(comment);
				if (result == null) result = caseEvent(comment);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
